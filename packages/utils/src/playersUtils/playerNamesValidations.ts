...
export const validatePlayersNames = (players: Player[]): PlayersNamesValidation => {
...
export const isPlayersNamesEmpty = (validations: PlayersNamesValidation, index: number) => {
  return validations.emptyNames.includes(index.toString());
};

export const isPlayersNamesRepeating = (validations: PlayersNamesValidation, index: number) => {
